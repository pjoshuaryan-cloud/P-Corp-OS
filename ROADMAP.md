...
Auth: full per-device auth (Keychain/Secure Enclave) or cloud/device sync are the remaining Layer 1 gaps — otherwise, keep going in order of importance per Joshua's standing instruction, unless he names something else.
