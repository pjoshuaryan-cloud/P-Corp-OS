...
/// Close port of desktop's own AlphaModeDashboardView.swift (2026-08-14) —
/// sixth of the deferred sidebar sections. Entirely built on PCorpKit's
/// already-cross-platform AlphaModeDashboardClient/AlphaModeProject/
/// AlphaModeInvoice/AlphaModeLead, no AppKit dependencies and no hover-
/// only affordances to adapt, so this is a direct, unmodified port.
