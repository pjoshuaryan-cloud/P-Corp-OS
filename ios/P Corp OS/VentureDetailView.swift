...
/// iOS port of desktop's own VentureDetailView.swift -- see that file's
/// docstring for the full reasoning (Phase 2, 2026-09-24). Presented as a
/// `.sheet(item:)` from VenturesView, matching this app's own
/// RunDetailSheet/MonteCarloDetailSheet precedent (NavigationStack +
/// inline title + a "Done" toolbar button), not the popover chrome
/// desktop uses.
