...
/// Close port of desktop's own AgentsView.swift (2026-08-13) — fourth of
/// the deferred sidebar sections. Entirely built on PCorpKit's already-
/// cross-platform AgentsClient/OperationsClient/Agent/OperationsTask/
/// IconColors, no AppKit dependencies and no hover-only affordances to
/// adapt, so this is a direct, unmodified port.
