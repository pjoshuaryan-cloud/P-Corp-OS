...
/// VENTURES Phase 3 (2026-09-24) -- the per-customer detail surface,
/// opened from VentureDetailView's Customers section. Hosts the
/// Fulfilment Engine's own checklist (same shape as the Launch Engine's
/// venture-level checklist, just scoped to a customer) plus a real
/// revenue-event ledger and a quick "Log Revenue" form. Shares the
/// parent's VenturesClient instance, same reasoning as VentureDetailView
/// itself sharing it with VenturesView.
